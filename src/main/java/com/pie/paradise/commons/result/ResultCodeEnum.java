...
public enum  ResultCodeEnum {
    ...
    /* 业务繁忙 请稍后在试 */
    BUSINESS_UNKNOWN_ERROR(30001, " busy with business", "业务繁忙 请稍后在试"),
    ...
    /*未知错误 请稍后在试*/
    SYSTEM_UNKNOWN_ERROR(40002, "system unknown error", "未知错误 请稍后在试"),
    /*内部系统接口调用异常*/
    ...
    ResultCodeEnum(int retCode, String retMsg, String tips) {
